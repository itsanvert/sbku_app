...
$classes = Flux::classes()
    ...
    ->add('text-base sm:text-sm text-zinc-700 disabled:text-zinc-500 placeholder-zinc-400 disabled:placeholder-zinc-400/70 dark:text-gray-300 dark:disabled:text-zinc-400 dark:placeholder-gray-400 dark:disabled:placeholder-zinc-500')
