<div class="space-y-6">
    <div>
        ...
        <flux:subheading>Update staff details and schedule</flux:subheading>
    </div>
    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <flux:field>
                ...
                <flux:select wire:model="major_id" size="sm" placeholder="Select Major" :disabled="!$faculty_id">
            ...
            <flux:field>
                ...
                <div class="flex items-center gap-4">
                    ...
                    @elseif ($existingPhoto)
                        <img src="{{ asset('storage/' . $existingPhoto) }}" class="w-16 h-16 rounded-xl object-cover ring-1 ring-zinc-200 dark:ring-white/10">
                    @else
