                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-[#374151]">
                        @forelse ($faculties as $faculty)
                            <tr class="hover:bg-gray-50/70 dark:hover:bg-[#263548]/50 transition-colors duration-100">
                                <td class="px-4 py-3 font-medium text-gray-900 dark:text-gray-50">{{ $faculty->name }}</td>
                                <td class="px-4 py-3 text-sm text-gray-400">{{ $faculty->created_at?->format('M j, Y') ?? '—' }}</td>
                                <td class="px-4 py-3">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-4 py-10 text-center text-gray-500 dark:text-gray-400">No faculties found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
