                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <thead>
                            <tr class="border-b border-gray-200 dark:border-[rgba(255,255,255,0.08)] bg-gray-50 dark:bg-[#1e293b]">
                                ...
                                <th class="px-4 py-3 text-xs font-semibold uppercase tracking-wide text-gray-400 dark:text-gray-500">
                                    Actions</th>
                            </tr>
                        </thead>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-2.5">
                                            <img class="h-7 w-7 rounded-lg object-cover ring-1 ring-gray-200 dark:ring-[#374151] shrink-0"
                                                ...
                                                alt="{{ $student->name }}" />
                                            <span class="font-medium text-gray-900 dark:text-gray-50 truncate">{{ $student->name }}</span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="11" class="px-4 py-14 text-center">
                                        <div class="flex flex-col items-center gap-1.5 text-gray-400 dark:text-gray-500">
                                            ...
                                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">No students found</p>
